# Game Character Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:gamecharacter-api:1.1.14'
}
```
...
```java
import com.apiverve.gamecharacter.GameCharacterGeneratorAPIClient;
import com.apiverve.gamecharacter.APIResponse;
import com.apiverve.gamecharacter.APIException;

// Initialize the client
GameCharacterGeneratorAPIClient client = new GameCharacterGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("race", "elf");
    parameters.put("class", "mage");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/gamecharacter](https://docs.apiverve.com/ref/gamecharacter)
...
- **Documentation:** [https://docs.apiverve.com/ref/gamecharacter](https://docs.apiverve.com/ref/gamecharacter)
- **Issues:** [GitHub Issues](https://github.com/apiverve/gamecharacter-api/issues)
