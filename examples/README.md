# Game Character Generator API - Examples

This folder contains example code for using the Game Character Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/gamecharacter',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/gamecharacter");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/gamecharacter](https://docs.apiverve.com/ref/gamecharacter)
