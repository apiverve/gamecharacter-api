...
{
    class GameCharacterGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/gamecharacter";

        /// <summary>
        /// Make a GET request to the Game Character Generator API
        /// </summary>
        static async Task<JsonDocument> CallGameCharacterGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;race&quot;] &#x3D; &quot;elf&quot;, [&quot;class&quot;] &#x3D; &quot;mage&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Game Character Generator API...\n");

            var result = await CallGameCharacterGeneratorAPI();
