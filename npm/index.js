...
class gamecharacterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/gamecharacter');
        }
        ...
        this.validationRules = {"race":{"type":"string","required":false},"class":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/gamecharacter`);
        }
    }
...
module.exports = gamecharacterWrapper;
