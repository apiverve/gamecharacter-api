...
namespace APIVerve\Gamecharacter;
...
/**
 * Client for the Game Character Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/gamecharacter?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/gamecharacter';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GamecharacterClient] {$message}\n";
        }
    }
}
