...
const (
	baseURL        = "https://api.apiverve.com/v1/gamecharacter"
	defaultTimeout = 30 * time.Second
)

// Client is the Game Character Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Game Character Generator API client.
...
// Execute makes a request to the Game Character Generator API with typed parameters.
//
